...
import { db } from '../db';
import { homeSliders, homeCampaigns, teamMembers, videos, books, magazines, settings } from '../db/schema';
...
async function seed() {
    ...
    // 4. Videos
    for (const video of [
        { id: uuidv4(), title: "Zamana Gawah Hai", videoUrl: "https://youtube.com", isFeatured: true },
        { id: uuidv4(), title: "Ameer Say Mulaqat", videoUrl: "https://youtube.com", isFeatured: true },
        { id: uuidv4(), title: "Khitab e Jummah", videoUrl: "https://youtube.com", isFeatured: true },
        { id: uuidv4(), title: "Policy Statement", videoUrl: "https://youtube.com", isFeatured: true }
    ]) {
    ...
    for (const magazine of [
        { id: uuidv4(), title: "Hikmat e Quran", isFeatured: true, slug: "hikmat-e-quran" },
        { id: uuidv4(), title: "MESSAQ", isFeatured: true, slug: "messaq" },
        { id: uuidv4(), title: "Nida e Khilafat", isFeatured: true, slug: "nida-e-khilafat" },
        { id: uuidv4(), title: "Perspective", isFeatured: true, slug: "perspective" }
    ]) {
    ...
    // 6. Books
    for (const book of [
        { id: uuidv4(), title: "Bayan ul Quran", isFeatured: true, slug: "bayan-ul-quran" },
        { id: uuidv4(), title: "More Asaan Arbi", isFeatured: true, slug: "asaan-arbi" },
        { id: uuidv4(), title: "More Seerat (SAW)", isFeatured: true, slug: "seerat-saw" },
        { id: uuidv4(), title: "More Books", isFeatured: true, slug: "more-books" }
    ]) {
