                        ...
                        {magazinesData.length > 0 ? magazinesData.map((mag, i) => (
                            ...
                            >
                                <div className="relative mb-6">
                                    ...
                                    <div className={cn(
                                        "relative w-[300px] sm:w-[180px] md:w-[260px] max-w-full aspect-[3/4] rounded-[1.5rem] overflow-hidden border border-border/50 bg-card shadow-[0_8px_30px_rgb(0,0,0,0.04)]",
