    ...
    <div ref={setNodeRef} style={style} className="flex items-center gap-4 bg-card border border-border p-4 rounded-xl shadow-sm mb-3">
      ...
      <div className="flex items-center gap-4 shrink-0">
        ...
        <div className="flex items-center gap-1 bg-muted/50 p-1 rounded-lg">
          <Button variant="ghost" size="icon" className={cn("h-8 w-8", link.isActive ? "text-blue-600 hover:text-blue-600 hover:bg-blue-600/70 hover:text-green-600" : "text-red-500 hover:bg-red-500/10 hover:text-red-600")} onClick={() => onToggleActive(link.id, !link.isActive)} title={link.isActive ? "Hide from frontend" : "Show on frontend"}>
