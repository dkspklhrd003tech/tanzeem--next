    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center pb-4 border-b border-border mb-6">
                <div>
                    <h1 className="text-3xl font-bold text-foreground tracking-tight">Home Sliders/Banners</h1>
                    ...
                    {bannerStyle === "slider" && (
                        <>
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 bg-primary text-white px-5 py-2.5 rounded-xl font-semibold shadow-sm hover:shadow-md transition-all active:scale-95"
                            >
