...
function SortableCard({ id, item, onEdit, onDelete }: SortableItemProps) {
  ...
  return (
    ...
    >
      <div className={cn("h-1.5 w-full", isPdf ? "bg-green-500" : "bg-emerald-500")} />
      ...
      <Tabs defaultValue="list" className="space-y-6">
        <TabsList className="bg-muted p-1 rounded-lg">
          <TabsTrigger value="list" className="flex items-center gap-2 px-4 py-2 rounded">
            <FileText className="w-4 h-4" /> Press Releases Grid
          </TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        placeholder="e.g. press release, statements, tanzeem, publications"
                      />
                    </div>
                  </CardContent>
                </Card>
