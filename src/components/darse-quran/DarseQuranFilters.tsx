...
export function DarseQuranFilters() {
    return (
        <section className="w-full max-w-7xl mx-auto mb-8">
            <div className="bg-white rounded-xl shadow-sm border border-border p-6 font-lato">
                ...
                <div className="mt-6 flex flex-col sm:flex-row justify-between items-center gap-4 pt-4 border-t border-border">
                    ...
                    <button className="flex items-center gap-2 bg-[#0d5844] hover:bg-[#0a4535] text-white px-6 py-2.5 rounded-lg text-sm font-bold shadow-md transition-colors w-full sm:w-auto justify-center">
