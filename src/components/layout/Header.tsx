          ...
          <div className="max-w-[1320px] mx-auto px-4 xl:px-0 flex justify-between items-center gap-4 text-sm">
            <div className="flex items-center gap-6">
              ...
              {settings.whatsapp_url && (
                <a href={settings.whatsapp_url} target="_blank" rel={EXTERNAL_LINK_REL} aria-label="WhatsApp — opens in new tab" className="w-7 h-7 rounded-full bg-primary flex items-center justify-center text-primary-foreground hover:bg-green-600 transition-colors shadow-sm focus-visible:outline-2 focus-visible:outline-ring focus-visible:outline-offset-2">
