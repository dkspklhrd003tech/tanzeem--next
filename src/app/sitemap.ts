...
const STATIC_ROUTES: { url: string; priority?: number; changeFrequency?: "daily" | "weekly" | "monthly" | "yearly" }[] = [
  ...
  { url: "/background", priority: 0.6, changeFrequency: "monthly" },
  { url: "/mission-statement", priority: 0.6, changeFrequency: "monthly" },
  { url: "/our-ideology", priority: 0.7, changeFrequency: "monthly" },
  { url: "/our-ideology/basic-belief", priority: 0.6, changeFrequency: "yearly" },
  { url: "/our-ideology/foundation", priority: 0.6, changeFrequency: "yearly" },
  { url: "/our-ideology/methodology", priority: 0.6, changeFrequency: "yearly" },
