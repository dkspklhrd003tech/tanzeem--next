...
const DEFAULT_CONTENT = `
  ...
  <p>
    According to the Quran, the obligations of a Muslim are not limited to personal worship. Every Muslim is obligated to actively participate in the struggle to make the word of Allah supreme (Iqamat-e-Deen).
  </p>
  ...
  <ul>
    ...
    <li><strong>Rights of Spouse:</strong> Fulfilling the mutual rights and responsibilities between husband and wife with love, respect, and justice.</li>
  ...
  <ul>
    ...
    <li><strong>Social Justice:</strong> Standing up for justice and fairness in all social, economic, and political matters.</li>
  ...
  <ul>
    ...
    <li><strong>Political Awareness:</strong> Understanding the political rights and responsibilities as a citizen and as a Muslim.</li>
    <li><strong>Opposing Injustice:</strong> Standing against oppression and tyranny in all forms, supporting the oppressed and marginalized.</li>
  </ul>
`;
...
export default async function OurObligationsPage() {
  ...
  const breadcrumbs = [
    ...
    { name: "Our Obligations", path: "/organization/our-ideology/our-obligations" },
  ];

  return (
    <ModernizedProsePage
      title={page?.title || "Our Obligations"}
      excerpt={page?.excerpt || "The critical obligations of Muslims regarding the establishment of Deen."}
      content={page?.content || DEFAULT_CONTENT}
      slug={SLUG}
      breadcrumbs={breadcrumbs}
      featuredImage={page?.featuredImage}
      ctaHeading="Explore Our Methodology"
      ctaSubheading="Understand the prophetic methodology for Islamic revolution and reform."
      ctaButtonLabel="Methodology"
      ctaButtonUrl="/organization/our-ideology/methodology"
    />
  );
}
