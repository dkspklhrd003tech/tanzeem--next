...
export const metadata = { title: "Mission Statement | Tanzeem-e-Islami" };
    ...
    <main className="min-h-screen bg-background">
      <div className="container mx-auto py-12 md:py-16">
        <article className="prose prose-lg dark:prose-invert max-w-4xl mx-auto">
          ...
          <ul>
            <li>
              <strong>Revival of Faith (Iman):</strong> To revive the true spirit of Iman (faith) in the hearts
              of Muslims, based on the understanding of the Quran and the Sunnah.
            </li>
            <li>
              <strong>Intellectual Awakening:</strong> To promote critical thinking and intellectual engagement
              with Islamic teachings, addressing contemporary challenges from an Islamic perspective.
            </li>
            <li>
              <strong>Moral Training (Tazkiyah):</strong> To provide spiritual and moral training to individuals
              so that they become exemplary Muslims and agents of positive change in society.
            </li>
            <li>
              <strong>Social Reform:</strong> To work for the reform of society based on Islamic values of justice,
              compassion, and brotherhood.
            </li>
            <li>
              <strong>Political Consciousness:</strong> To create awareness among Muslims about their political
              rights and responsibilities, and to work for the establishment of the Islamic system of governance.
            </li>
            <li>
              <strong>Unity of the Ummah:</strong> To promote unity and cooperation among different Islamic
              movements and organizations for the collective revival of the Ummah.
            </li>
          </ul>
          <h2>Our Vision</h2>
          <p>
