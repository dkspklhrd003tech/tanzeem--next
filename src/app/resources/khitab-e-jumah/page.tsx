                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className={
                        ...
                        {categories.map((cat: any) => {
                            ...
                            return (
                                <Link href={`/resources/khitab-e-jumah/category/${cleanSlug}`} key={cat.id} className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 rounded-xl border border-primary/50 hover:border-border/50 bg-muted/50 hover:bg-primary-light/80 transition-colors cursor-pointer group shadow-sm hover:shadow-md h-full">
