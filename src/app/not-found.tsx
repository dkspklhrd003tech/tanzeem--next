      ...
      <div className="text-center px-4 py-10 relative z-10 w-full max-w-2xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/"
              className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-primary text-white font-medium hover:bg-primary/90 transition-colors shadow-lg shadow-primary/20"
            >
              Home
            </Link>
            <Link
