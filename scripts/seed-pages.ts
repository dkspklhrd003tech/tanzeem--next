...
const SEED_PAGES = [
    {
        ...
        content: `
      <div class="space-y-6">
        <p class="text-lg leading-relaxed text-foreground-muted">Tanzeem-e-Islami is an Islamic organization that was founded by Dr. Israr Ahmed in 1975. Our ultimate goal is the establishment of the Islamic system of life and the re-establishment of Khilafah in the modern world.</p>
        <p class="text-lg leading-relaxed text-foreground-muted">The foundational principles of Tanzeem-e-Islami are based upon the Quran and Sunnah, and it strictly adheres to the methodology prescribed by Prophet Muhammad (PBUH) for Islamic revolution.</p>
        <h2 class="text-2xl font-bold mt-8 mb-4 text-foreground">Our History</h2>
        <p class="text-lg leading-relaxed text-foreground-muted">After evaluating the condition of Muslims and various religious organizations, Dr. Israr Ahmed concluded that a distinctly specialized party must be formed to strive for the Iqamat-e-Deen (establishment of religion) comprehensively.</p>
      </div>
    `,
    ...
    },
    {
        ...
        content: `
      <div class="space-y-6">
        <p class="text-lg leading-relaxed text-foreground-muted">We welcome your inquiries, feedback, and questions. Please reach out to our central office using the information below.</p>
